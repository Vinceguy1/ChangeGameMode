...
public class GmA
{
	public static void Command(CommandSender sender)
	{
		...
		{
			me.Vinceguy1.ChangeGameMode.Functions.Message.Function(me.Vinceguy1.ChangeGameMode.ConfigClass.config.get("Messages.Errors.In-game Player").toString(), sender, null, null, false, false, true, null);
		}
		else
		{
